...
- (instancetype)init
{
    self = [super init];
    if (self) {
        _colorZero = [UIColor colorWithRed:195.0f/255.0f green:25.0f/255.0f blue:25.0f/255.0f alpha:1.0f];
        ...
        _colorSix = [UIColor colorWithRed:98.0f/255.0f green:91.0f/255.0f blue:77.0f/255.0f alpha:0.8];
    }
    return self;
}
